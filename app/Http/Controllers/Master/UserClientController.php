...
use App\MasterModel\UserClientsModel;
...
class UserClientController extends Controller
{
    ...
    {
     $this->middleware('permission:UserClients.index', ['only' => ['index']]);
     $this->middleware('permission:UserClients.create', ['only' => ['create','store']]);
     $this->middleware('permission:UserClients.edit', ['only' => ['edit','update']]);
     $this->middleware('permission:UserClients.destroy', ['only' => ['destroy','deleteAll']]);
     $this->middleware('permission:UserClients.print', ['only' => ['export']]);
   }
   public function index(Request $request)
   {
     $data = UserClientModel::Fetch($request);
     return view('Master.UserClients.default',compact('data'));
   }
    ...
    {      
      $d=new UserClientModel;
      return view('Master.UserClients.form',compact('d'));
    }
    ...
    $update =UserClientModel::where('id',$id)->first();
    if(!$request->file('foto'))
    {
    ...
    {
     $delete =UserClientModel::where('id',$id)->first();
     $delete->status='F';
     $delete->update();
